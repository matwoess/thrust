...
pub const CHAR_SHOT_SHIP_BASIC: char = '|';
pub const CHAR_SHOT_SHIP_STRONG: char = '█';
pub const CHAR_SHOT_SHIP_DIAGONAL_L: char = '\\';
pub const CHAR_SHOT_SHIP_DIAGONAL_R: char = '/';
